...
class MinusPlusButtonsFrame(tk.Frame):
    def __init__(self, *args, **kwargs):
        ...
        self.__btn_minus = tk.Button(self,text="-",
                                     padx=4,pady=4,
                                     width=1,height=1,
                                     font=(None,18))

        self.__btn_plus = tk.Button(self, text="+",
                                    padx=4, pady=4,
                                    width=1,height=1,
                                    font=(None,18))
...
class CounterFrame(tk.Frame):
    def __init__(self,*args,label="Cчетчик",**kwargs):
...
class ProbeControlFrame(tk.Frame):
    ...
    def __init__(self,*args,**kwargs):
        ...
        label = tk.Label(self,text="Управление зондом",
                         font=(None,18))
